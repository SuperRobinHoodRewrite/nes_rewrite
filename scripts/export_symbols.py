...
# https://github.com/jrs0ul/nes_survival/blob/master/fceux_symbols.py
# It might have its own license.
###############################################################################
...
if __name__ == "__main__":
    label_to_nl("robin.nes.labels.txt", "robin.nes.ram.nl", 0x0000, 0x7FF)
    label_to_nl("robin.nes.labels.txt", "robin.nes.0.nl", 0x8000, 0xBFFF)
    label_to_nl("robin.nes.labels.txt", "robin.nes.1.nl", 0xC000, 0xFFFF)
